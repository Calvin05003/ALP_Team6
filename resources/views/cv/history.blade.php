<x-app-layout>
    <div class="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-slate-100 relative overflow-hidden">
        ...
        <div class="max-w-5xl mx-auto py-12 px-4 sm:px-6 lg:px-8 relative">
            ...
            <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
                ...
                <a href="{{ route('cv.create') }}"
                   class="group inline-flex items-center justify-center rounded-2xl bg-sky-600 px-6 py-3 text-sm font-bold text-white shadow-xl shadow-sky-900/20 hover:bg-sky-500 hover:-translate-y-1 transition-all active:scale-95">
            ...
            <div class="grid gap-6">
                @forelse($histories as $index => $h)
                    <div class="group relative rounded-3xl border border-slate-800 bg-slate-900/40 p-6 backdrop-blur-xl transition-all duration-300 hover:border-slate-600 hover:bg-slate-900/60 shadow-xl">
                            ...
                            <div class="flex flex-wrap items-center gap-3 lg:pl-6 lg:border-l lg:border-slate-800">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <form method="POST" action="{{ route('cv.history.delete', $h->id) }}" 
                                        ...
                                        @csrf @method('DELETE')
                                        <button type="submit" class="p-2 rounded-xl bg-rose-500/10 text-rose-500 hover:bg-rose-500 hover:text-white transition-all border border-rose-500/20">
                ...
                @empty
                    <div class="rounded-3xl border-2 border-dashed border-slate-800 p-12 text-center">
